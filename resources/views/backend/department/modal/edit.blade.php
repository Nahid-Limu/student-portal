<div id="editDepartment" tabindex="-1" role="dialog" aria-labelledby="modal-responsive-label" aria-hidden="true"
    class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                <h4 id="modal-responsive-label" class="modal-title">Edit Department</h4>
            </div>
            <form id="edit_department_modal_form">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-md-12">
                                <label for="edit_department_name" class="pull-left">
                                    <h5>Edit Department Name:</h5>
                                </label>
                                <div>
                                    <input class="form-control select2Style" type="text" name="edit_department_name"
